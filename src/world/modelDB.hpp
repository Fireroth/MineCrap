...
extern const glm::vec3 cubeFaceVertices[6][4];
extern const glm::vec3 cactusFaceVertices[6][4];
...
extern const glm::vec2 slabUvs[4];
extern const glm::vec2 liquidUvs[4];
extern const glm::vec2 pebbleUvs[4];
extern const glm::vec2 carpetUvs[4];